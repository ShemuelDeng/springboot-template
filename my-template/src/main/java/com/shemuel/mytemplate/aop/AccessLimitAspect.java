package com.shemuel.mytemplate.aop;

import cn.dev33.satoken.stp.StpUtil;
import com.shemuel.mytemplate.annotation.AccessLimit;
import com.shemuel.mytemplate.common.RestResult;
import com.shemuel.mytemplate.service.IRateLimiter;
import com.shemuel.mytemplate.utils.RateLimiterFactory;
...
public class AccessLimitAspect {
    ...
    // 环绕通知
    @Around("within(@com.shemuel.mytemplate.annotation.AccessLimit *) && within(com.shemuel.mytemplate.controller..*) || " +
            "@annotation(com.shemuel.mytemplate.annotation.AccessLimit) && within(com.shemuel.mytemplate.controller..*)")
